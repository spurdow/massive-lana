...
public class LoginFragment$$ViewInjector {
  public static void inject(Finder finder, final gtg.virus.gtpr.LoginFragment target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131230891, "field 'authButton' and method 'onAuthButton'");
    ...
    view = finder.findRequiredView(source, 2131230888, "field 'mUsername'");
    target.mUsername = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131230889, "field 'mPassword'");
