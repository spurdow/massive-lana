        ...
        if(extras != null){
         ...
         new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
             ...
             /**
              * <mPaint>Runs on the UI thread after {@link #doInBackground}. The
              * specified result is the value returned by {@link #doInBackground}.</mPaint>
              * <mPaint/>
              * <mPaint>This method won't be invoked if the task was cancelled.</mPaint>
              *
